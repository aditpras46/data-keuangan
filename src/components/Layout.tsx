...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900 flex items-center justify-center font-sans overflow-x-hidden">
      ...
      <div className="w-full max-w-md min-h-screen md:h-[850px] md:min-h-0 bg-white dark:bg-[#0b101c] md:rounded-none md:shadow-2xl overflow-hidden relative flex flex-col border-[8px] border-slate-900 shadow-3xl">
        
        {/* Notch */}
        <div className="hidden md:block absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-slate-900 z-50"></div>
        ...
        <header className="bg-primary px-6 pt-12 pb-4 flex justify-between items-center text-white">
          ...
          <div className="flex items-center gap-3">
             ...
             <div className="w-10 h-10 rounded-none overflow-hidden border-2 border-white/20 shadow-lg bg-white/20 flex items-center justify-center">
                {user?.avatarUrl ? (
                  <img 
                    src={user.avatarUrl} 
                    alt="avatar" 
        ...
        <div className="bg-primary px-6 py-2 overflow-visible relative">
           <div className="absolute -top-10 left-0 right-0 h-12 bg-primary"></div>
