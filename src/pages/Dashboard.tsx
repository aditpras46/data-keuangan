...
export default function Dashboard() {
  ...
  return (
    <div className="animate-in fade-in duration-700 bg-[#f8fbff] min-h-screen">
      ...
      <div className="bg-primary text-white pt-6 pb-12 px-6 rounded-b-[3rem] shadow-xl relative overflow-hidden">
        {/* Connection Status Badge */}
        <div className="flex justify-center mb-6">
           <div className={cn(
             "px-4 py-1.5 rounded-full flex items-center gap-2 backdrop-blur-md border",
        ...
        <div className="flex items-center justify-between mb-8">
           <button onClick={() => changeMonth(-1)} className="p-2 bg-white/10 rounded-xl hover:bg-white/20">
              <ChevronLeft size={20} />
           </button>
      ...
      {/* Demo Mode Guide */}
      {isDemo && (
        <div className="mx-6 mt-6 p-6 bg-amber-50 border border-amber-100 rounded-[2rem] shadow-sm">
                ...
                <div key={idx} className="space-y-2">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                       <div className={cn("w-2.5 h-2.5 rounded-full", colors[idx % colors.length])}></div>
                  ...
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <motion.div 
                      ...
                      className={cn("h-full rounded-full shadow-sm", colors[idx % colors.length])}
                    />
                  </div>
                </div>
              );
      ...
      <div className="px-6 pb-24">
         <div className="flex items-center gap-4 p-5 bg-white rounded-[2rem] shadow-lg border border-slate-50">
